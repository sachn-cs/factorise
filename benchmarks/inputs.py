...
IS_PRIME_SMALL: Final[list[tuple[str, int]]] = [
    ("two", 2),
    ("small_prime", 97),
    ("small_composite", 100),
    ("prime_37", 37),
...
IS_PRIME_MEDIUM: Final[list[tuple[str, int]]] = [
    ("prime_1e9", 10**9 + 7),
...
IS_PRIME_LARGE: Final[list[tuple[str, int]]] = [
...
FACTORISE_SMALL: Final[list[tuple[str, int]]] = [
    ("n12", 12),  # 2^2 * 3
    ("n24", 24),  # 2^3 * 3
    ("n360", 360),  # 2^3 * 3^2 * 5
...
FACTORISE_MEDIUM: Final[list[tuple[str, int]]] = [
...
FACTORISE_LARGE: Final[list[tuple[str, int]]] = [
...
SCALABILITY_INPUTS: Final[list[tuple[str, int]]] = [
    ("n_1e2", 100),
    ("n_1e4", 10_000),
