...
class PollardRhoStage(FactorStage):
    ...
    This stage wraps the existing pollard_brent implementation from
    factorise.core and exposes it via the FactorStage interface. It is the
    primary general-purpose factorisation method in the pipeline.
    """
